...
#endif
    setObjectName("DaytraderCoin");
    setStyleSheet("#DaytraderCoin { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(tr("&About DaytraderCoin"), this);
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; font-size: 14px; font-weight: 400; font-variant: small-caps; padding: 3px; border: none;}"
                           "QToolButton:hover { background-color: #000000; border-radius: 3px; padding-top: 3px; padding-bottom: 3px; }"
                           "QToolButton:checked { background-color: #000000; border-radius: 3px; padding-top: 3px; padding-bottom: 3px; }"
                           "QToolButton:pressed { background-color: #000000; border-radius: 3px; padding-top: 3px; padding-bottom: 3px; }"
...
{
    QString strTitle = tr("DaytraderCoin") + " - ";
