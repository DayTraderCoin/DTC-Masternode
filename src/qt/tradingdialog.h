...
private slots:
    ...
    QString BuyDTC(QString OrderType, double Quantity, double Rate);
    QString SellDTC(QString OrderType, double Quantity, double Rate);
